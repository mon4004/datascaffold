...
`datascaffold` package has bien uploaded to git_hub. To install the package it is necessary to use  `devtools` package. This is the example of how to install it. 
